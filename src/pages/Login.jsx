    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-950 relative overflow-hidden px-6">
            ...
            <div className="w-full max-w-md bg-slate-900/50 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl relative">
                <Link to="/get-started" className="absolute top-6 left-6 text-slate-400 hover:text-white transition-colors">
                ...
                <div className="text-center mb-8 mt-4">
                    ...
                    <p className="text-slate-400">
                        Login as <span className="text-cyan-400 font-semibold capitalize">{role}</span>
                    </p>
                </div>
                ...
                <p className="text-center mt-8 text-slate-400">
                    ...
                    <Link to={`/signup?role=${role}`} className="text-cyan-400 hover:text-cyan-300 font-medium hover:underline">
                        Sign up
                    </Link>
                </p>
            </div>
